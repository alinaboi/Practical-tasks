...
class OrderSummaryPage extends BasePage {
  ...
  get appleJuiceText() {
    return new Label(
      $('(//mat-cell[contains(text(),"Apple Juice")])'),
      "Apple Juice Text"
    );
  }
  ...
  get carrotJuiceText() {
    return new Label(
      $('(//mat-cell[contains(text(),"Carrot Juice")])'),
      "Carrot Juice Text"
    );
  }
  ...
  get greenSmoothieText() {
    return new Label(
      $('(//mat-cell[contains(text(),"Green Smoothie")])'),
      "Green Smoothie Text"
    );
  }
  ...
  get lemonJuiceText() {
    return new Label(
      $('(//mat-cell[contains(text(),"Lemon Juice")])'),
      "Lemon Juice Text"
    );
  }
  ...
  get orangeJuiceText() {
    return new Label(
      $('(//mat-cell[contains(text(),"Orange Juice")])'),
      "Orange Juice Text"
    );
  }
  ...
  get salesmanArtworkText() {
    return new Label(
      $('(//mat-cell[contains(text(),"Salesman Artwork")])'),
      "Salesman Artwork Text"
    );
  }

  get permafrost2020EditionText() {
    return new Label(
      $('(//mat-cell[starts-with(text()," Juice Shop")])'),
      "Permafrost 2020 Edition Text"
    );
  }

  get melonBikeText() {
    return new Label(
      $('(//mat-cell[contains(text(),"Melon Bike")])'),
      "Melon Bike Text"
    );
  }
  ...
  get submitOrderBtn() {
    return new Button(
      $('(//span[contains(text(), "Place your order and pay")])'),
      "Submit Order Button"
    );
  }
